    ...
    <div class="columns is-centered mt-4">
        <div class="column is-6">
            <div class="box">
                ...
                <%--                    <ul>--%>
                <%--                        <li class="is-active xyz" data-target="favorite"><a> <span class="icon is-small"><i--%>
                <%--                                class="fas fa-photo-video"></i></span> <span>Favorite</span>--%>
                <%--                        </a></li>--%>
                <%--                        <li data-target="favorite-user"><a> <span class="icon is-small"><i--%>
                <%--                                class="fas fa-list"></i></span> <span>Favorite--%>
                <%--										Users</span>--%>
                <%--                        </a></li>--%>
                <%--                        <li data-target="shared-friend"><a> <span class="icon is-small"><i--%>
                <%--                                class="fas fa-list"></i></span> <span>Shared--%>
                <%--										Friends</span>--%>
                <%--                        </a></li>--%>
                <%--                    </ul>--%>
                <%--                </div>--%>
                ...
                <div class="px-2" id="tab-content">
                    <!-- favorite tab -->
                    <div class="panel is-info mb-6" id="favorite">
                    ...
                    <!-- favorite user tab -->
                    <div class="panel is-info mb-6" id="favorite-user">
                        <p class="panel-heading mb-2">
                            Favorites by video
                        </p>
                                    ...
                                    <div class="field">
                                        <div class="control">
                                            <div class="select is-fullwidth">
                                                    <select name="videoUserId" onchange="this.form.submit();">
                    ...
                    <!-- shared friend tab -->
                    <div class="panel is-info" id="shared-friend">
                        <p class="panel-heading mb-2">
                            Shares by video
                        </p>
                        <form action="Report" method="post">
                            <div class="field is-horizontal">
                                ...
                                <div class="field-body">
                                    <div class="field">
                                        <div class="control">
                                            <div class="select is-fullwidth">
                                                <select name="videoShareId" onchange="this.form.submit();">
