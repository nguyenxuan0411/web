...
<script src="${pageContext.request.contextPath}/main/webapp/views/admin/js/script.js" defer></script>
</head>
							...
							<form action="${url}/index" method="post">
								<div class="columns">
									<div class="column mt-5 is-5 is-flex is-align-items-center is-flex-direction-column">
										<figure class="image">
											<img
												src="${empty form.poster ? 'https://cdn.pixabay.com/photo/2015/12/03/01/27/play-1073616_960_720.png' : form.poster}"
