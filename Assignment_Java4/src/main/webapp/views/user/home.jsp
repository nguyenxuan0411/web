        ...
        <div class="container">
            <div class="buttons is-centered">
                <form action="Home" method="get">
                    <button class="submit" type="submit" name="page" value=1>
						<span class="icon"> <i class="fas fa-angle-double-left"></i>
						</span>
                    </button>
                    <button class="submit" type="submit" ${currentPage == 1 ? 'disabled="disabled"' : ''} name="page" value="${currentPage - 1}">
						<span class="icon"> <i class="fas fa-chevron-left"></i>
						</span>
                    </button>
                    <span class="has-text-weight-bold m-3">Page ${currentPage} of ${totalPage}</span>
                    <button class="submit" type="submit" ${currentPage == totalPage ? 'disabled="disabled"' : ''} name="page" value="${currentPage + 1}">
						<span class="icon"> <i class="fas fa-chevron-right"></i>
						</span>
                    </button>
                    <button class="submit" type="submit" name="page" value="${totalPage}">
