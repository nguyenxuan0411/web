		...
		<div class="container">
			<div class="columns is-centered mt-6">
				<div class="column is-4">
					<h1 class="block title has-text-centered">REGISTRATION</h1>
					<form action="" method="post" class="box" id="form-login">
						...
						<div class="field">
							...
							<div class="control">
								<input type="text" class="input" name="userId" value="${user.userId}">
							</div>
						</div>
						<div class="field">
						...
						<div class="field">
							<div class="control">
								<button class="button is-fullwidth is-primary" type="submit" name="signupBtn">Sign Up</button>
							</div>
						</div>
					</form>
				</div>
