					...
					<form action="" method="post" class="box" id="form-login">
						<div class="field">
							...
							<div class="control has-icons-left">
								<input type="text" class="input" name="userId" value="${userId}"> <span class="icon is-small is-left">
						...
						<div class="field">
							...
							<div class="control has-icons-left">
								<input type="password" class="input" name="currentPassword"> <span class="icon is-small is-left">
